    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center">
      ...
      <main className="w-full border-x border-foreground flex flex-col min-h-screen relative overflow-hidden text-sm">
        ...
        <section className="relative w-full aspect-[3/4] sm:aspect-square border-b border-foreground flex flex-col justify-end p-4 group">
          ...
          <div className="absolute bottom-4 sm:bottom-8 left-4 right-4 sm:left-auto sm:right-8 z-20 flex flex-col items-start sm:items-end sm:w-max max-w-[calc(100%-2rem)]">
            ...
            {/* The Text Block */}
            <div className="font-display text-[clamp(0.875rem,4vw,1.25rem)] sm:text-[8px] font-bold sm:font-normal tracking-widest uppercase text-left sm:text-right bg-dark-surface/90 sm:bg-transparent backdrop-blur-md sm:backdrop-blur-none p-4 sm:p-0 border border-foreground sm:border-0 drop-shadow-lg sm:drop-shadow-none">
